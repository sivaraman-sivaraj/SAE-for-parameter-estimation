...
np.savetxt('yaw_regression_coeff.txt', coeff)
np.save('yaw_regression_coeff.npy', coeff)
...
def Errotplot1():
    ...
    plt.suptitle('Mean Square Error Plot of Auto-encoders Training')
...
def Errorplot4(rf1,y):
    ...
    plt.title("Predicted and Actual scatter Plot")
